...
inline IloCplex::Callback CheckIncumbentCallbackHandle(IloEnv env, const IloNumVarArray x, const std::shared_ptr<const Graph> g, const std::shared_ptr<const Graph> gr, const double eps) {
